...
import 'package:catlog/app/domain/either/either.dart' as _i3;
import 'package:catlog/app/domain/models/breeds/breeds.dart' as _i10;
import 'package:catlog/app/domain/models/failure/response_failure.dart' as _i9;
import 'package:catlog/app/domain/repositories/breeds_repository.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBreedsRepository extends _i1.Mock implements _i8.BreedsRepository {
  MockBreedsRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i3.Either<_i9.ResponseFailure, List<_i10.Breeds>>> getBreeds({
    int? page = 0,
    int? limit = 20,
  }) =>
      (super.noSuchMethod(
            ...
            returnValue:
                _i4.Future<
                  _i3.Either<_i9.ResponseFailure, List<_i10.Breeds>>
                >.value(
                  _FakeEither_2<_i9.ResponseFailure, List<_i10.Breeds>>(
                    this,
          ...
          as _i4.Future<_i3.Either<_i9.ResponseFailure, List<_i10.Breeds>>>);
}
